...
const Footer = () => {
  ...
  return (
    <div className="row text-light">
      <div className="col-lg-6 col-md-6 col-sm-12 address-section1" style={{padding:"5%"}}>
      ...
      {footerLinks.map((link, index) => (
        <div key={index} className={link.classes}>
          <h5 className="footer-title tx-dark fw-500 text-light" style={{marginTop:"25%"}}>{link.title}</h5>
      ...
      <div className="col-xl-3 text-light">
        <div className="logo fs-20 mt-20 mb-30" style={{ textAlignLast: "center", marginTop:"25%" }}>
          <Link to="/">
