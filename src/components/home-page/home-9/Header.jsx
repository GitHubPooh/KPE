        ...
        <div className="row gx-0 d-lg-flex">
          <div className="col-lg-6 col-sm-12 col-md-4 px-0 text-start">
            <div className="h-100 d-inline-flex align-items-center py-0 me-0">
              <a href="/index.html" className="navbar-brand d-flex sticky-top px-4 px-lg-2">
                <img src="/assets/images/logoimg.jfif" alt="Logo" style={{ height: '80px', width: '115px' }} />
              </a>
              <div>
          ...
          <div className="col-lg-6 d-none d-lg-flex justify-content-end" style={{ paddingRight: '0px' }}>
            ...
            <div className="h-100 d-inline-flex align-items-center">
              <a href="#" className="btn btn-sm-square bg-white me-1"><i className="fab fa-facebook-f"></i></a>
              <a href="#" className="btn btn-sm-square bg-white me-1"><i className="fab fa-twitter"></i></a>
              <a href="#" className="btn btn-sm-square bg-white me-1"><i className="fab fa-youtube"></i></a>
              <a href="#" className="btn btn-sm-square bg-white me-0"><i className="fab fa-instagram"></i></a>
            </div>
          </div>
        </div>
      </div>
